...
{
    public class RegisterSenderCommandValidator : AbstractValidator<RegisterSenderCommand>
    {
        public RegisterSenderCommandValidator(UserManager<ApplicationUser> userManager, IAddressValidationService addressValidationService)
        {
