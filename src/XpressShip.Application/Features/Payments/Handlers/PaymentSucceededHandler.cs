...
namespace XpressShip.Application.Features.Payments.Handlers
{
    public class PaymentSucceededHandler : INotificationHandler<PaymentSucceededNotification>
    {
        ...
        public PaymentSucceededHandler(IEmailService emailService, IPaymentMailTemplatesService paymentMailTemplatesService, IPaymentRepository paymentRepository, IUnitOfWork unitOfWork)
        {
